...
MODELS = ["catalyst_ohe", "selected_2", "selected_5", "pc_top", "pc_scores"]
...
METHODS = ["lolo", "iid_stratified_5", "kfold_stratified_5", "kfold_5"]
# Defaults for this bundle's dataset; inputs/config.json overrides both.
TARGET = "conversion"
GROUP = "catalyst"
# Same two/five descriptor sets as the Perera and Doyle benchmarks, so the
# sections are directly comparable across all three.
