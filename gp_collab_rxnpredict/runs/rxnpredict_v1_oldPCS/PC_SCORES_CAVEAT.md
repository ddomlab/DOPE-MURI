...
lost outright. With 4 ligands there are at most 3 independent ligand
...
UNAFFECTED and remain valid. `rxnpredict_full` and `rxnpredict_full_ohe` are likewise unaffected.
